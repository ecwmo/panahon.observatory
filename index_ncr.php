...
<div class="section01">
   <h2 id="mmbservations">24-Hr Metro Manila Rainfall Observations:
   <a href="http://panahon.observatory.ph/index_ncr3day.php" target="_blank"> 3-Day graphs are here</a>
   </h2>
   </div>
...
<div class="section01c">
    ...
    <ul>
	 ...
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Manila Observatory for the last 24 hours.</li>
   ...
   <div class="box b0102 bhalf">
    ...
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Nangka, Marikina City for the last 24 hours.</li>
         <li> The image was last updated <?php
        // Open the text file
   ...
   <div class="box b0201 bhalf">
    ...
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at MMDA-MO Guadalupe for the last 24 hours.</li>
          <li> The image was last updated <?php
        // Open the text file
   ...
   <div class="box b0202 bhalf">
    ...
    <img src="/resources/met/makati01/rain.png" alt="Bgy. San Lorenzo, Makati City Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
   ...
   <div class="box b0301 bhalf">
    ...
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
         <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Bgy. San Antonio, Makati City for the last 24 hours.</li>
          <li> The image was last updated <?php
        // Open the text file
   ...
   <div class="box b0302 bhalf">
    ...
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
         <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at OSMAK Bgy. Pembo, Makati City for the last 24 hours.</li>
          <li> The image was last updated <?php
        // Open the text file
