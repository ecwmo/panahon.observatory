  ...
  <div class="bg-gray-300 border border-t-0 border-black flex flex-col items-center" x-data="stationSelect()">
    <div class="w-full flex flex-col md:flex-row bg-gray-400 border-b border-black text-xs p-3 gap-2 content-center">
      ...
      <div class="flex gap-1.5">
        ...
        <label class="inline-flex items-center">
          <input type="radio" name="mapSlct" class="h-3 w-3" @click="changeMap('mm')" checked><span class="ml-1">Metro
            Manila</span>
        </label>
      </div>
      <!-- Station Dropdown -->
    ...
    <div class="flex flex-col-reverse md:flex-row md:justify-center gap-4 p-6">
      ...
      <div class="flex text-sm text-center items-center">
        ...
        <div class="flex flex-col items-center" :class="showMoreInfo ? '' : 'gap-2 md:gap-4'">
          ...
          <div class="flex" :class="showMoreInfo ? 'flex-col' : 'flex-col gap-2 md:flex-row md:gap-4'">
            ...
            <div :class="activeVariable === 'rain' ? 'bg-blue-600 text-gray-900' : 'bg-blue-300 text-gray-800'"
              class="relative flex flex-col justify-center cursor-pointer py-3 px-2 border border-black w-60" id="prain"
              @click="setActiveVariable('rain')">
            ...
            <div :class="activeVariable === 'temp' ? 'bg-blue-600 text-gray-900' : 'bg-blue-300 text-gray-800'"
              class="relative flex flex-col justify-center cursor-pointer py-3 px-2 border border-black w-60" id="ptemp"
              @click="setActiveVariable('temp')">
          ...
          <div class="flex" :class="showMoreInfo ? 'flex-col' : 'flex-col gap-2 md:flex-row md:gap-4'">
            ...
            <div :class="activeVariable === 'wind' ? 'bg-blue-600 text-gray-900' : 'bg-blue-300 text-gray-800'"
              class="relative flex flex-col justify-center cursor-pointer py-3 px-2 border border-black w-60" id="pwind"
              @click="setActiveVariable('wind')">
              ...
              <div class="flex justify-evenly">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <div class="flex justify-center items-center">
                    ...
                    <div class="text-2xl font-semibold ml-1" x-text="`${activeStation.obs.wdirStr}`">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div :class="activeVariable === 'pres' ? 'bg-blue-600 text-gray-900' : 'bg-blue-300 text-gray-800'"
              class="relative flex flex-col justify-center cursor-pointer py-3 px-2 border border-black w-60" id="ppres"
              @click="setActiveVariable('pres')">
        ...
        <!-- More Info Panel -->
        <div class="hidden md:relative md:flex text-base md:text-lg w-52 lg:w-64 md:h-full" x-show="showMoreInfo"
          x-cloak>
          <div
            class="group flex items-center justify-center absolute right-2 top-2 cursor-pointer shadow-lg w-5 h-5 text-xs stroke-current text-gray-800 hover:text-gray-900 hover:bg-blue-300 rounded-full"
          ...
          <div class="flex bg-blue-600 pt-5 px-5 border border-black border-l-0 break-normal text-left">
            ...
            <div x-show="activeVariable === 'rain'">
              At <span class="font-semibold" x-text="activeStation.name"></span>, there was <span class="font-semibold"
                x-text="`${(activeStation.obs.rr * 10.)} mm`">0 mm</span>
              rainfall
