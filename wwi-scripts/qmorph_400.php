...
$input = array("00", "01", "02", "03", "04", "05", "06");
$stdate = explode("\n",file_get_contents('../wwi-data/satellite/qmorph_timestamps'));
$font = './arial.ttf';
...
imagecolortransparent($map, $blank);
  ...
  $handle = fopen("../wwi-data/satellite/qmorph".$input[$i].".csv", "r");
...
//      case $data[2] > 0: imagesetpixel($map, $x, $y, $c1); break;
  ...
  imagepng($map, '../wwi-images/qmorph'.$input[$i].'.png', 9, PNG_NO_FILTER);
  imagefill($map, 0, 0, $blank);
}
