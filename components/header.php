<header class="bg-blue-900 pt-1 border border-black md:flex-col flex flex-row justify-between shadow-lg text-gray-200">
    <div class="flex text-xs m-1 mb-2">
        ...
        <div class="hidden md:inline border-l border-black px-2">
            ...
            <p>Email: <a href="mailto:manila@observatory.ph" title="Manila Observatory email address" class="hover:text-blue-400">manila@observatory.ph</a></p>
        </div>
    </div>
