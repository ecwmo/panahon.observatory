...
?>
 ...
 <body>
  ...
  <div class="section01">
   <h2 id="mobservations">Mindanao Rainfall Observations</h2>
   <div class="box b0101 bhalf">
    <h3><a href="http://www.observatory.ph/Metdata/xuws2" target="_blank">Xavier University: Cagayan de Oro</a></h3>
   ...
   <div class="box b0102 bhalf">
    <h3><a href="http://www.observatory.ph/Metdata/zipzone" target="_blank">Dahilayan Aventure Park, Bukidnon</a></h3>
    <img src="/resources/met/zipzone/rain.png" alt="Bukidnon Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Dahilayan for the last 24 hours.</li>
     <li>Data made available to the Manila Observatory through partnership with Engr. Elpidio Paras.</li>
    </ul>
   </div>
   <div class="box b0201 bhalf">
    <h3><a href="http://www.observatory.ph/Metdata/MOD" target="_blank">MO Davao Station</a></h3>
    <img src="/resources/met/MOD/rain.png" alt="Davao Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Davao for the last 24 hours.</li>
    </ul>
   </div>
   <div class="box b0202 bhalf">
    <h3><a href="http://www.observatory.ph/Metdata/mo003" target="_blank">Notre Dame of Marbel University, Koronadal City</a></h3>
    <img src="/resources/met/mo003/rain.png" alt="Koronadal Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Koronadal for the last 24 hours.</li>
    </ul>
   </div>
  </div>
...
<li><a href="http://www.observatory.ph/Metdata/zipzone">Dahilayan Adventure Park, Bukidon</a></li>
<li><a href="http://www.observatory.ph/Metdata/MOD">Manila Observatory, Davao Station</a></li>
