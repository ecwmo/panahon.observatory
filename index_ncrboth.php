...
<div class="section01">
   <h2 id="mmbservations">Metro Manila Rainfall Observations</h2>
   </div>
...
<div class="section01c">
    ...
    <div class="box b0101 bhalftwo">
    <h3><a href="http://www.observatory.ph/Metdata/MO" target="_blank">Manila Observatory, Quezon City</a></h3>
    <img src="/resources/met/MO/rain.png" alt="Manila Observatory, Quezon City Rainfall (mm)"/>
    ...
    <ul>
	 ...
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Manila Observatory for the last 24 hours & 3 days.</li>
   ...
   <div class="box b0102 bhalftwo">
    <h3><a href="http://www.observatory.ph/Metdata/mo001" target="_blank">Nangka, Marikina City</a></h3>
    <img src="/resources/met/mo001/rain.png" alt="Nangka, Marikina City Rainfall (mm)"/>
    <img src="/resources/met/mo001/rain3day.png" alt="Nangka, Marikina City 3 Day Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
 	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Nangka, Marikina City for the last 24 hours & 3 days.</li>
         <li> The image was last updated <?php
        // Open the text file
   ...
   <div class="box b0201b bhalftwo">
    <h3><a href="http://www.observatory.ph/Metdata/mo004" target="_blank">M0-MMDA Station, Guadalupe</a></h3>
    <img src="/resources/met/mo004/rain.png" alt="MO-MMDA Guadalupe Rainfall (mm)"/>
    <img src="/resources/met/mo004/rain3day.png" alt="MO-MMDA Guadalupe 3 Day Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at MMDA-MO Guadalupe for the last 24 hours & 3 days.</li>
          <li> The image was last updated <?php
        // Open the text file
   ...
   <div class="box b0202b bhalftwo">
    <h3><a href="http://www.observatory.ph/Metdata/makati05" target="_blank">Bgy. Forbes Park, Makati City</a></h3>
    <img src="/resources/met/makati05/rain.png" alt="Bgy. Forbes Park, Makati City Rainfall (mm)"/>
    <img src="/resources/met/makati05/rain3day.png" alt="Bgy. Forbes Park, Makati City 3 Day Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
	 <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Bgy. Forbes Park, Makati City for the last 24 hours.</li>
          <li> The image was last updated <?php
        // Open the text file
        $f = fopen('/home/webman/websites/panahon.observatory.ph/resources/met/makati05/datetime.csv', "r");
        echo fgets($f);
        // Close the text file
        fclose($f);
        ?> </li>
   ...
   <div class="box b0301b bhalftwo">
    <h3><a href="http://www.observatory.ph/Metdata/makati03" target="_blank">Bgy. San Antonio, Makati City</a></h3>
    <img src="/resources/met/makati03/rain.png" alt="Bgy. San Antonio, Makati City Rainfall (mm)"/>
    <img src="/resources/met/makati03/rain3day.png" alt="Bgy. San Antonio, Makati City 3 Day Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
         <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at Bgy. San Antonio, Makati City for the last 24 hours & 3 days.</li>
          <li> The image was last updated <?php
        // Open the text file
   ...
   <div class="box b0302b bhalftwo">
    <h3><a href="http://www.observatory.ph/Metdata/makati06" target="_blank">OSMAK Bgy. Pembo, Makati City</a></h3>
    <img src="/resources/met/makati06/rain.png" alt="OSMAK Bgy. Pembo, Makati City Rainfall (mm)"/>
    <img src="/resources/met/makati06/rain3day.png" alt="OSMAK Bgy. Pembo, Makati City 3 Day Rainfall (mm)"/>
    <ul>
     <li>The bar graph in the figure shows hourly rainfall (the values are seen on the left y-axis).</li>
         <li>The filled in section shows the accumulated rain (the values are seen on the right y-axis) at OSMAK Bgy. Pembo, Makati City for the last 24 hours & 3 days.</li>
          <li> The image was last updated <?php
        // Open the text file
