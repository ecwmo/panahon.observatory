<template>
  <button
    type="submit"
    :class="[
      'text-white font-medium rounded-lg text-sm w-auto md:w-full px-5 py-2.5 text-center',
      !disabled
...
<script setup lang="ts">
  withDefaults(defineProps<{ disabled?: boolean; isPending?: boolean; pendingText?: string }>(), {
    disabled: false,
    isPending: false,
