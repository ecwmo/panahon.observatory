...
<body class="bg-gray-600 w-full md:w-4/5 mx-auto">
    ...
    <div class="bg-gray-300 border-l border-r border-b border-black flex py-4 justify-center" x-data="newReport()">
        <div class="flex flex-col bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <p class="p-1 mb-3">Click <a href="/reports.php" class="underline text-blue-600 hover:text-blue-800 visited:text-purple-600">here</a></p>
            <?php } else if (array_key_exists('uploaded', $_GET)) { ?>
            <h4 class="p-4 flex justify-center text-3xl font-medium">Upload success!</h4>
            <p class="p-1 mb-3">Preview the document <a href="/reports.php?view=draft" target="_blank" class="underline text-blue-600 hover:text-blue-800 visited:text-purple-600">here</a></p>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4"> 
                    ...
                    <label 
                        ...
                        <span class="mt-2 text-base truncate" x-text="fileName ? fileName.replace(/^.*[\\\/]/, '') : 'Select a file'"></span>
